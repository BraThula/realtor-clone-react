...
function Profile() {
  ...
  return (
    <>
      <section className="max-w-6x1 mx-auto flex justify-items-center items-center flex-col">
        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form action="">
            <input
              ...
              onChange={onChange}
              className={`mb-6 w-full px-4 py-2 text-xl text-grey-700 bg-white border border-gray-300 rounded transition ease-in-out ${
          ...
          >
            ...
            >
              <FcHome className="mr2 text-3xl bg-red-200 rounded-full p-1 border-2" />
